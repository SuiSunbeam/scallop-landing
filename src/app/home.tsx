...
import krissAvatar from '@/assets/images/kriss-avatar.png';
import annAvatar from '@/assets/images/ann-avatar.png';
import shawnAvatar from '@/assets/images/shawn-avatar.jpg';
import donnieAvatar from '@/assets/images/donnie-avatar.png';
import nathanAvatar from '@/assets/images/nathan-avatar.png';
...
const Home = () => {
  ...
  return (
    <div className="Home">
      ...
      {showBTT && <ArrowUpIcon className="Back-to-top" onClick={backToTop} />}
    </div>
  );
};
export default Home;
